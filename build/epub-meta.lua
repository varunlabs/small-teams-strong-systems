...
--
-- No heading-level rewriting is done here: the v1 PDF is rendered as a
-- continuous flow that mirrors how the EPUB reads, so headings stay inline
-- rather than being promoted to page-breaking parts/chapters.
function Meta(m)
  m.title = nil
  m.subtitle = nil
  m.author = nil
