...
The long-term consequence of design is cumulative. A system built on explicit reasoning strengthens with use. A system reliant on informal compensation becomes increasingly dependent on endurance. Contributors in the first kind of system accumulate knowledge and context that transfers. Contributors in the second accumulate workarounds that remain personal, because the knowledge lives in people rather than in structure.
...
- Boeing 737 MAX case study (Chapter 7): U.S. House Committee on Transportation and Infrastructure, *Final Committee Report: The Design, Development & Certification of the Boeing 737 MAX* (September 2020).
...
- Instagram's 13-person team at $1 billion acquisition by Facebook (2012): referenced in Chapter 11. Source: Ryan Mac, "Instagram: More Popular Than Twitter, And Worth Nothing," *Forbes*, March 13, 2012.
- Toyota Georgetown manufacturing cell model (Chapter 11): Jeffrey K. Liker, *The Toyota Way: 14 Management Principles from the World's Greatest Manufacturer* (McGraw-Hill, 2004). The andon cord and work-cell ownership model is documented extensively in Liker's analysis of Georgetown's production system relative to American automotive peers.
- Beat Saber team size and acquisition (Chapter 12): Dean Takahashi, "Facebook Acquires Beat Games, the Studio Behind Beat Saber," *VentureBeat*, November 26, 2019.
- Amazon's "Working Backwards" process (Chapter 8): Colin Bryar and Bill Carr, *Working Backwards: Insights, Stories, and Secrets from Inside Amazon* (St. Martin's Press, 2021).
...
- Basecamp's organizational philosophy (Chapter 15): Jason Fried and David Heinemeier Hansson, *It Doesn't Have to Be Crazy at Work* (Harper Business, 2018).
