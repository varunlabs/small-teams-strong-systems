## Chapter 7 â€” Human Judgment vs. Machine Execution
...
> **Figure 7.1 â€” Interpretation vs. Procedure**
>
>
...
> **Figure 7.2 â€” Misallocated Judgment**
>
>
...
*If drift, overload, or inconsistency appear in your system, are they symptoms of effort â€” or of a boundary that was never deliberately defined?*
...
> **Figure 7.3 â€” Small System Sensitivity**
>
>
...
Stewardship of judgment also involves managing escalation. If every uncertainty rises to the top, the system becomes brittle. If none do, drift accumulates invisibly. Effective leadership defines thresholds â€” conditions under which reinterpretation must occur and conditions under which execution continues uninterrupted.
...
> **Figure 7.4 â€” Leadership in a Judgment-Heavy System**
>
>
...
As execution becomes easier to scale, scarcity shifts toward interpretation â€” the act of defining intent under uncertainty. The stability of the system depends on knowing where judgment ends and execution begins, yet those boundaries are rarely explicit.
...
1. Can every team member name the three most consequential decisions made in the last cycle â€” and who owned them?
...
6. When a decision turns out poorly, can you trace it to a specific judgment call â€” or does responsibility diffuse?
...
10. Are your most experienced people spending their time on interpretation â€” or on routine execution that could be delegated?

**Scoring:** Count your "No" answers. 0â€“2: boundaries are well-maintained. 3â€“5: boundary drift is likely â€” examine where judgment has quietly migrated to execution or vice versa. 6+: the judgment-execution boundary needs deliberate redesign before execution scales further.

---

**In Practice: Boeing 737 MAX â€” Execution Without Judgment**

The Boeing 737 MAX crashes of 2018 and 2019 are a case study in judgment-execution boundary failure. The MCAS safety system â€” designed to correct for aerodynamic instability â€” was treated as an execution problem (automated control) when it required judgment (pilot-visible, pilot-overridable decision authority). Certification processes, designed for earlier aircraft generations, proceduralized an assumption that stall scenarios would be rare edge cases. They were not. When MCAS activated incorrectly, pilots lacked the contextual information to override it â€” not because they weren't capable, but because the boundary between automated execution and human judgment had been deliberately obscured to avoid costly retraining. 346 people died. The planes were grounded for 20 months. The cost exceeded $20 billion. The engineering was sophisticated. The frame around it was not.
...
- Judgment â€” interpreting meaning, resolving ambiguity, owning uncertainty â€” cannot be automated. It can only be abdicated, which is a different and more dangerous outcome.
...
- The boundary between judgment and execution must be designed deliberately. Left undesigned, it drifts toward whatever produces the fastest output â€” not the best choice.
- Highly capable execution systems make poor judgment placement more consequential, not less. Speed amplifies direction.
- Leaders are accountable for where judgment resides in the team â€” not just for the quality of their own decisions, but for the conditions under which all decisions are made.
:::
